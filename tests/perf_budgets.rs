...
const BUDGETS: &[Budget] = &[
    ...
    Budget {
        ...
        unit: "us",
        threshold: 200.0,
        methodology: "pijs_workload: 2000 iterations x 1 tool call, perf profile (not generated by the CI benchmark job)",
        ci_enforced: false,
    },
    Budget {
        ...
        methodology: "pijs_workload: 2000 iterations x 10 tool calls, perf profile (not generated by the CI benchmark job)",
        ci_enforced: false,
    },
    // ── Event Dispatch ───────────────────────────────────────────────────
    Budget {
...
#[test]
fn classify_budget_status_does_not_fail_non_ci_budget_without_data() {
    let budget = BUDGETS
        .iter()
    ...
    assert_eq!(classify_budget_status(budget, None, true), "NO_DATA");
}
